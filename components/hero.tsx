    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <a
            href="#usluge"
            className="brand-glow-hover w-full rounded-lg bg-[#e30016] px-8 py-4 text-sm font-semibold uppercase tracking-widest text-white transition-all duration-300 hover:bg-[#ff2a3d] sm:w-auto"
          >
            {"Na\u0161e Usluge"}
          </a>
          <a
